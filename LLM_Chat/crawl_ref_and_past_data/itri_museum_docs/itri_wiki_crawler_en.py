...
def create_enhanced_qa_pairs(self, data: Dict[str, Any]) -> List[Dict[str, str]]: """Create comprehensive Q&A pairs for the chatbot""" qa_pairs = [] # Basic organization info qa_pairs.extend([ { "question": "What is the Institute of Industrial Research?", "answer": f"Industrial Research Institute ({data['organization_name']}) is the most important industrial technology research and development institution in Taiwan, focusing on industrial technology research and development and innovation." }, { "question": "What is the English name of the Institute of Industrial Research Institute?", "answer": f"The English name of the Institute of Technology is {data['english_name']}, referred to as ITRI." }, { "question": "What is the main task of the Institute of Technology?", "answer": "The main tasks of the Institute of Technology include: industrial technology research and development, technology transfer, talent cultivation, industrial services, etc., and are committed to enhancing Taiwan's industrial competitiveness." }, { "question": "In which year was the Institute of Technology established?", "answer": "The Institute of Technology was established in 1973 and was promoted by Sun Yunqi, then Minister of Economic Affairs." }, { "question": "Where is the headquarters of the Institute of Technology?", "answer": "The Institute of Technology is headquartered in Hsinchu, Taiwan, and has offices in the United States, Europe and Japan." } ]) # Add section-based Q&A if 'sections' in data: for section_name, content in data['sections'].items(): if isinstance(content, dict): # Handle subscriptions for subscription_name, subscription_content in content.items(): if 'Evolution' in subscription_name or 'History' in subscription_name: qa_pairs.append({ "question": f"How about {subsection_name} of the Institute of Engineering Research?", "answer": f"{subsection_name}: {subsection_content[:800]}..." }) else: # Handle main sections if 'Evolution' in section_name or 'History' in section_name: qa_pairs.append({ "question": "What is the historical evolution of the Institute of Technology?", "answer": f"The historical evolution of the Institute of Technology: {content[:800]}..." }) elif 'organization' in section_name: qa_pairs.append({ "question": "What is the organizational structure of the Institute of Technology?", "answer": f"The organizational structure of the Institute of Technology: {content[:800]}..." }) elif 'Honor' in section_name or 'Award' in section_name: qa_pairs.append({ "question": "What honors and awards are there in the Institute of Technology?", "answer": f"Honors and awards are there in the Institute of Technology: {content[:800]}..." }) # Add leadership Q&A if 'leadership' in data: for position, leaders in data['leadership'].items(): if leaders: if isinstance(leaders, list): qa_pairs.append({ "question": f"What {position} are there in the Institute of Technology?", "answer": f"The {position} of the Institute of Technology include: {', '.join(leaders[:10])}" }) elif isinstance(leaders, list) and len(leaders) > 0 and isinstance(leaders[0], dict): # Handle table data leader_names = [leader.get('value', '') for leader in leaders if leader.get('value')] if leader_names: qa_pairs.append({ "question": f"What are the {position} of the {position} of the {technical research institute?", "answer": f"The {position} of the {technical research institute include: {', '.join(leader_names[:10])}" }) # Add achievements Q&A if 'achievements' in data and data['achievements']: qa_pairs.append({ "question": "What important achievements has the Institute of Technology?", "answer": f"The important achievements of the Institute of Technology include: {';'.join(data['achievements'][:10])}" }) # Add awards Q&A if 'awards' in data and data['awards']: qa_pairs.append({ "question": "What awards has the Institute of Technology won?", "answer": f"The important awards won by the Institute of Technology include: {';'.join(data['awards'][:10])}" }) # Add alumni Q&A if 'notable_alumni' in data and data['notable_alumni']: qa_pairs.append({ "question": "What outstanding hospitalists are there in the Institute of Technology and Research?",

"answer": f"The outstanding residents of the Institute of Technology include: {', '.join(data['notable_alumni'][:10])}" }) # Add research areas Q&A if 'research_areas' in data and data['research_areas']: qa_pairs.append({ "question": "What research areas does the Institute of Technology mainly engage in?", "answer": f"The research areas mainly engage in include: {';'.join(data['research_areas'][:10])}" }) # Add international presence Q&A if 'international_offices' in data and data['international_offices']: qa_pairs.append({ "question": "What offices does the Industrial Research Institute have overseas?", "answer": f"The Industrial Research Institute has overseas offices, including: {';'.join(data['international_offices'][:5])}" }) # Add controversies Q&A (if any) if 'controversies' in data and data['controversies']: qa_pairs.append({ "question": "What disputes have occurred in the Industrial Research Institute?", "answer": f"The controversial events that have occurred in the Institute of Technology include: {';'.join(data['controversies'][:5])}" }) return qa_pairs
