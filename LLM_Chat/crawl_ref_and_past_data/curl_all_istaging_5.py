...
# 設置基本參數
BASE_URL_TEMPLATE = "https://livetour.istaging.com/1f0c00df-79f8-45c5-a0ad-d41ad38abc35?group=6e760cfc-cfa4-4b4f-b227-0ca674b18638&locale={}&index={}"
LOCALES = ["us", "zh-tw"]  # 英文和中文版本
MAX_SCENES = 2  # 最大場景數量，可以根據需要調整
DOWNLOAD_DIR = "LLM_Chat/itri_online_museum_docs/istaging_html_5"
OUTPUT_DIR = "LLM_Chat/itri_online_museum_docs/istaging_parsed_5"
TIMEOUT = 30  # 請求超時時間（秒）
...
def main():
    print(f"開始下載和解析第五個 iStaging 虛擬導覽 (綠能永續展區)，最大場景數量: {MAX_SCENES}，語言: {', '.join(LOCALES)}")
    ...
    for locale in LOCALES:
        ...
        with open(output_txt, "w", encoding="utf-8") as f:
            title = "工研院線上展示館資訊 (綠能永續展區-英文版)" if locale == "us" else "工研院線上展示館資訊 (綠能永續展區-中文版)"
            f.write(f"# {title}\n\n")
            f.write(f"本文件包含從工研院線上展示館虛擬導覽中提取的所有綠能永續展品信息 ({locale})。\n\n")
