...
# 設置基本參數
BASE_URL_TEMPLATE = "https://livetour.istaging.com/7087343b-eafa-40bb-9874-3a1ee06bb108?group=6e760cfc-cfa4-4b4f-b227-0ca674b18638&locale={}&index={}"
LOCALES = ["us", "zh-tw"]  # 英文和中文版本
MAX_SCENES = 2  # 最大場景數量，可以根據需要調整
DOWNLOAD_DIR = "LLM_Chat/itri_online_museum_docs/istaging_html_2"
OUTPUT_DIR = "LLM_Chat/itri_online_museum_docs/istaging_parsed_2"
TIMEOUT = 30  # 請求超時時間（秒）
